...
export function getHomeScreenContent(projectName: string): string{
...
export function getThemeFileContent(projectName: string): string{
  const pascalProjectName = changeCase.pascalCase(projectName);
  return `import 'package:flutter/material.dart';
...
export function getDiFileContent(): string{
  return `import 'package:flutter/material.dart';
...
export function getMainFileContent(projectName: string): string{
  const pascalProjectName = changeCase.pascalCase(projectName);
  return `import 'package:flutter/material.dart';
...
export function getPubspecFileContent(projectName: string): string{
