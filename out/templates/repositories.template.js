...
exports.getFirestoreRepositoryContent = exports.getBaseRepositoryContent = void 0;
const changeCase = require("change-case");
const pluralize = require('pluralize');
function getBaseRepositoryContent(projectName, name) {
...
exports.getBaseRepositoryContent = getBaseRepositoryContent;
function getFirestoreRepositoryContent(projectName, name) {
    const pascalName = changeCase.pascalCase(name);
    const snakeName = changeCase.snakeCase(name);
    const camelName = changeCase.camelCase(name);
    const pluralizedName = pluralize(name);
...
exports.getFirestoreRepositoryContent = getFirestoreRepositoryContent;
//# sourceMappingURL=repositories.template.js.map